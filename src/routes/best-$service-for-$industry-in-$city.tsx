...
import { resolveServiceIndustryCity, seoHeadFor } from "@/lib/seo/resolve";

export const Route = createFileRoute("/best-$service-for-$industry-in-$city")({
  loader: ({ params }) =>
    resolveServiceIndustryCity(params.service, params.industry, params.city),
...
function Page() {
  ...
  return (
    <MarketingLayout>
      <SeoLandingTemplate
        eyebrow={`${d.serviceName} · ${d.industryName} · ${d.cityName}`}
        h1={d.h1}
