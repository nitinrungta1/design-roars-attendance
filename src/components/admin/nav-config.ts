...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    icon: UsersRound,
    items: [
      { to: "/admin/workforce/employees", label: "Employees", icon: Users },
      { to: "/admin/workforce/attendance", label: "Attendance", icon: Clock },
      { to: "/admin/workforce/timesheets", label: "Timesheets", icon: ClipboardList },
      { to: "/admin/workforce/shifts", label: "Shifts", icon: CalendarRange },
